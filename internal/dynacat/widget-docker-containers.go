...
const (
	dockerContainerLabelHide        = "dynacat.hide"
	dockerContainerLabelName        = "dynacat.name"
	dockerContainerLabelURL         = "dynacat.url"
	dockerContainerLabelDescription = "dynacat.description"
	dockerContainerLabelSameTab     = "dynacat.same-tab"
	dockerContainerLabelIcon        = "dynacat.icon"
	dockerContainerLabelID          = "dynacat.id"
	dockerContainerLabelParent      = "dynacat.parent"
	dockerContainerLabelCategory    = "dynacat.category"
)
...
func fetchDockerContainersFromSource(
	...
	for i := range containers {
		...
		for label, value := range overrides {
			container.Labels["dynacat."+label] = value
		}
	}
